...
public interface AccountService {
     ...
     * @throws AppException if the customer does not exist ({@code CUSTOMER_NOT_FOUND}) or the account number already exists ({@code ACCOUNT_NUMBER_EXISTED})
     */
    ...
    PageResponse<AccountResponse> getInactiveAccountsByCustomerId(Long customerId, int page, int size);
