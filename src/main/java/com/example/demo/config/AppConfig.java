...
public class AppConfig {
  ...
  private static final String DEVELOPMENT_ADMIN_USERNAME = "admin12345";
  private static final String DEVELOPMENT_ADMIN_PASSWORD = "admin12345";
   ...
   * @throws AppException when the runner executes and the development administrator role cannot be
   *     found ({@code ROLE_NOT_FOUND})
   */
  @Bean
  public ApplicationRunner applicationRunner(UserRepository userRepository) {
    return args -> {
      if (!userRepository.existsByUsername(DEVELOPMENT_ADMIN_USERNAME)) {
        ...
        Set<AppRole> roles = Set.of(AppRole.ADMIN);
        User user =
            User.builder()
