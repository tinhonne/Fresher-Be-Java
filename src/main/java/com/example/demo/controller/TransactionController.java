...
public class TransactionController {
     ...
     * @throws AppException if the amount is invalid ({@code INVALID_TRANSFER_AMOUNT}), the accounts are identical ({@code SAME_ACCOUNT_TRANSFER}), an account does not exist ({@code SOURCE_ACCOUNT_NOT_FOUND} or {@code DESTINATION_ACCOUNT_NOT_FOUND}), or an account is inactive ({@code SOURCE_ACCOUNT_INACTIVE} or {@code DESTINATION_ACCOUNT_INACTIVE})
     */
