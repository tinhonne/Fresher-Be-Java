...
public class CustomerController {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<ApiResponse<CustomerResponse>> getCustomerById(@Positive @PathVariable Long id) {
    ...
    public ResponseEntity<ApiResponse<PageResponse<CustomerResponse>>> getAllCustomerSortByName(
        ...
        return ResponseEntity.ok(ApiResponse.success(customerService.getAllCustomerSortByName(page, size)));
    }
    ...
    public ResponseEntity<ApiResponse<PageResponse<CustomerResponse>>> getCustomerSortByField(
            ...
            @PositiveOrZero @RequestParam(defaultValue = "0") int page,
            @Min(1) @Max(100) @RequestParam(defaultValue = "10") int size) {
        return ResponseEntity.ok(ApiResponse.success(customerService.getCustomerSortByField(request, page, size)));
    }
    ...
    public ResponseEntity<ApiResponse<PageResponse<AccountResponse>>> getCustomerAccounts(
            ...
            @PositiveOrZero @RequestParam(defaultValue = "0") int page,
            @Min(1) @Max(100) @RequestParam(defaultValue = "10") int size) {
        return ResponseEntity.ok(ApiResponse.success(accountService.getAccountsByCustomerId(id, page, size)));
    }
    ...
    public ResponseEntity<ApiResponse<PageResponse<AccountResponse>>> getInactiveCustomerAccounts(
            ...
            @PositiveOrZero @RequestParam(defaultValue = "0") int page,
            @Min(1) @Max(100) @RequestParam(defaultValue = "10") int size) {
        return ResponseEntity.ok(ApiResponse.success(accountService.getInactiveAccountsByCustomerId(id, page, size)));
    }
}
