...
public class AccountController {
   ...
   * @throws AppException if the customer does not exist, is inactive, the account number exists, or
  ...
  public ResponseEntity<ApiResponse<PageResponse<AccountResponse>>> getAccountSortByNameCustomer(
    ...
    return ResponseEntity.ok(
        ApiResponse.success(accountService.getAccountSortByNameCustomer(page, size)));
  }
  ...
  private ResponseEntity<ApiResponse<AccountResponse>> accountByNumber(String accountNumber) {
    return ResponseEntity.ok(
        ApiResponse.success(accountService.getAccountByAccountNumber(accountNumber)));
  }
}
